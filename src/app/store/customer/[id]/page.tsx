  ...
  invoices = await invoicesResponse.json();
    ...
    return (
      <div className="flex  items-center justify-center p-6">
        <div className="text-center max-w-sm rounded-2xl bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100">
          ...
          <p className="mt-2 text-sm text-slate-500">
            We couldn't load the details for this customer. They may have been removed or an error occurred.
          </p>
          <Link
            href="/store/customer"
  ...
  return (
    <div className="min-h-full p-6 sm:p-10">
      ...
      <div className="mb-8 rounded-3xl border border-slate-100 bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div>
              ...
              <div className="mt-3 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm font-medium text-slate-500">
                <span className="flex items-center gap-1.5">
                  ...
                  Code: <span className="text-slate-700">{customer.customer_code}</span>
                </span>
                
                {customer.gstin_uin && (
                  <span className="flex items-center gap-1.5">
                    <FileText size={16} className="text-slate-400" />
                    GSTIN: <span className="text-slate-700">{customer.gstin_uin}</span>
                  </span>
                )}
              </div>
            </div>
          ...
          <div className="flex shrink-0 items-center gap-3">
             <button className="flex h-12 items-center justify-center rounded-xl bg-slate-50 px-6 text-sm font-semibold text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900 border border-slate-200">
                Edit Profile
             </button>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="flex flex-col gap-8">
          <div className="rounded-3xl border border-slate-100 bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
            ...
            <div className="space-y-6">
              {/* Contact */}
              <div>
                <div className="flex items-center gap-2 font-mono text-[11px] font-medium uppercase tracking-[0.2em] text-slate-400 mb-2">
                  <Phone size={14} />
                  Contact Person
                </div>
                <div className="text-base font-medium text-slate-700">
                  {customer.contact_person || "No contact specified"}
                </div>
              </div>
              ...
              <div className="rounded-xl bg-slate-50 p-4 border border-slate-100">
                <div className="font-mono text-[11px] font-medium uppercase tracking-[0.2em] text-slate-400 mb-1">
                  Registered State ID
                </div>
        ...
        {/* Right Column: Previous invoices */}
        <div className="rounded-3xl border border-slate-100 bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] lg:col-span-2">
          <div className="flex items-end justify-between border-b border-slate-100 pb-6 mb-2">
            <div>
          ...
          <div className="divide-y divide-slate-100">
            {invoices.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <h4 className="text-base font-medium text-[#0f172a]">No invoices yet</h4>
                <p className="mt-1 text-sm text-slate-500">
                  There is no billing history associated with this account.
                </p>
              </div>
            ) : (
              invoices.map((invoice) => (
                <Link
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="text-base font-bold text-[#0f172a] group-hover:text-indigo-700 transition-colors">
                  ...
                  <div className="flex items-center justify-between sm:flex-col sm:items-end sm:justify-center pl-16 sm:pl-0">
