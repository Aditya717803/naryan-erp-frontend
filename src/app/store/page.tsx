...
export default function StoreDashboardPage() {
  ...
  const inventoryData = useMemo(() => {
    ...
    return [
      ...
      { name: "Low Stock", value: dashboard.summary.low_stock_count },
      { name: "Out of Stock", value: dashboard.summary.out_of_stock_count },
    ];
  }, [dashboard]);

  const inventoryHealth = useMemo(() => {
    if (!dashboard || dashboard.summary.total_products === 0) return 0;
    ...
    return Math.round(
      (healthy / dashboard.summary.total_products) * 100,
    );
  }, [dashboard]);
        ...
        >
          <div className="mb-4">
            ...
            <p className="mt-1 text-xs text-slate-500">
              Jump directly into common ERP operations.
            </p>
          </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-0.5 text-lg font-semibold text-slate-900">
                  {summary.total_stock.toLocaleString("en-IN")} units
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-0.5 text-lg font-semibold text-slate-900">
                  {summary.out_of_stock_count} products
                </p>
              </div>
            </div>
